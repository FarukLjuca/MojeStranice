                ...
                <form method="post" action="AdminPanel.php">
                    <table>
                        <tr>
                            ...
                            $rezultat = $veza->query("SELECT idNovost FROM novost");
                            ...
                            foreach ($rezultat as $id) {
                                $oznacen = "";
                                if (isset($_POST['idNovostiM']) && $_POST['idNovostiM'] == $id['idNovost'])
                                    $oznacen = "selected='selected'";
                                echo "<option ".$oznacen.">".$id['idNovost']."</option>";
                            }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (isset($_POST['idNovost']) && isset($_POST['naslovNovostiM']) && isset($_POST['tekstNovostiM']) && isset($_POST['detaljnijiTekstNovostiM']) && isset($_POST['slikaNovostiM'])) {
                                    if (strlen(trim($_POST['naslovNovostiM'])) == 0)
                                        echo "Naslov novost ne smije ostati prazan!";
                                    else if (strlen(trim($_POST['tekstNovostiM'])) == 0)
                                        echo "Tekst novost ne smije ostati prazan!";
                                    else {
                                        ...
                                        $rezultat = $veza->query("SELECT alias FROM administrator WHERE username = '".$_SESSION['username']."'");
                                        ...
                                        $rezultat = $veza->prepare("UPDATE novost SET naslov=?, tekst=?, autor=?, detaljnijiTekst=?, slika=?, datumObjave=NOW() WHERE idNovost=?");
                                        $rezultat->execute(array($naslov, $tekst, $autor, $detaljnijiTekst, $slika, $_POST['idNovost']));
                                        ...
                                        echo "<span style='color: green'>Uspješna modifikacija novost.</span>";
                ...
                <form method="post" action="AdminPanel.php">
                    <table>
                        <tr>
                            ...
                            foreach ($rezultat as $id) {
                                $tekstBrisanje = "<option>".$id['idNovost']."</option>";
                                if (isset($_POST['idNovostiB']) && $_POST['idNovostiB'] == $id['idNovost'])
                                    $tekstBrisanje = "";
                                echo $tekstBrisanje;
                            }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (isset($_POST['idNovostiB'])) {
                                    ...
                                    echo "<span style='color: green'>Uspješno brisanje novost.</span>";
                ...
                <form method="post" action="AdminPanel.php">
                    <table>
                        <tr>
                            ...
                            $rezultat = $veza->query("SELECT idKomentari FROM komentar");
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (isset($_POST['idKomentariB'])) {
                                    ...
                                    $rezultat = $veza->prepare("DELETE FROM komentar WHERE idKomentari=?");
                            ...
                            <td>
                                ...
                                if (isset($_POST['usernameAdmina']) && isset($_POST['aliasAdmina']) && isset($_POST['mailAdmina']) && isset($_POST['pass1']) && isset($_POST['pass2'])) {
                                    if (strlen(trim($_POST['usernameAdmina'])) == 0)
                                        ...
                                        $rezultat = $veza->prepare("SELECT * FROM administrator WHERE username=?");
                ...
                <form method="post" action="AdminPanel.php">
                    <table>
                        <tr>
                            ...
                            <td><select name="idAdministrator">
                            ...
                            $rezultat = $veza->query("SELECT idAdministrator FROM administrator");
                            ...
                            foreach ($rezultat as $id) {
                                echo "<option>".$id['idAdministrator']."</option>";
                                $tekstBrisanje = "<option>".$id['idAdministrator']."</option>";
                                if (isset($_POST['idAdministrator']) && $_POST['idAdministrator'] == $id['idAdministrator'])
                                    $tekstBrisanje = "";
                                echo $tekstBrisanje;
                            }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (isset($_POST['idAdministrator'])) {                                 
                                    $veza = new PDO("mysql:dbname=milenijumsoft;host=127.13.49.130;charset=utf8", "Faruk", "tajna");
                                    $veza->exec("set names utf8");

                                    $rezultat = $veza->prepare("SELECT username FROM administrator WHERE idAdministrator=?");
                                    $rezultat->execute(array($_POST['idAdministrator']));
            ...
            <div id="prikazNovosti" class="adminAkcijaVidljiv">
                <table class="tblAdminPrikaz">
                    ...
                    <?php
                        $veza = new PDO("mysql:dbname=milenijumsoft;host=127.13.49.130;charset=utf8", "Faruk", "tajna");
                        $veza -> exec("set names utf8");
                        $rezultat = $veza -> query("SELECT idNovost, naslov, tekst, detaljnijiTekst, UNIX_TIMESTAMP(datumObjave) vrijeme, autor, slika
                                                    FROM novost");
                        ...
                        foreach ($rezultat as $novost) {
                            ...
                            if ($novost['detaljnijiTekst'] == null)
                                $detaljnijeString = "Bez detalja";

                            echo "<tr>".
                                "<td><small>".$novost['idNovost']."</small></td>".
            ...
            <div id="prikazKomentari" class="adminAkcijaNevidljiv">
                <table class="tblAdminPrikaz">
                    ...
                    <?php
                        $veza = new PDO("mysql:dbname=milenijumsoft;host=127.13.49.130;charset=utf8", "Faruk", "tajna");
                        $veza -> exec("set names utf8");
                        $rezultat = $veza -> query("SELECT idKomentar, idNovost, autor, mail, UNIX_TIMESTAMP(vrijemeObjave) vrijeme, tekst,
                                                    (
                                                        SELECT naslov
                                                        FROM novost
                        ...
                        foreach ($rezultat as $komentar) {
                            echo "<tr>".
                                "<td><small>".$komentar['idKomentar']."</small></td>".
                                "<td><small>".$komentar['idNovost']."</small></td>".
            ...
            <div id="prikazAdministratori" class="adminAkcijaNevidljiv">
                <table class="tblAdminPrikaz">
                    ...
                    <?php
                        $veza = new PDO("mysql:dbname=milenijumsoft;host=127.13.49.130;charset=utf8", "Faruk", "tajna");
                        $veza -> exec("set names utf8");
                        $rezultat = $veza -> query("SELECT idAdministrator, alias, username, mail
                                                    FROM administrator");
                        ...
                        foreach ($rezultat as $admin) {
                            echo "<tr>".
                                "<td><small>".$admin['idAdministrator']."</small></td>".
        ...
        <div id="logiranjeForma">
            <form method="post" action="AdminPanel.php">
                ...
                if (isset($_POST['username']) && isset($_POST['password'])) {
                    ...
                    $rezultat = $veza -> prepare("SELECT * FROM administrator WHERE username=? && password=md5(?)");
