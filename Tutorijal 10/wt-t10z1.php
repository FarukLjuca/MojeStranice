...
<html>
<head>
	<title>Tutorijal 10, Zadatak 1</title>
	<meta charset="UTF-8">
...
<body>
	<div style='float:right;'>
        ...
        <div id="loginForma" style="display: none">
            <form method="post" action="wt-t10z1.php">
    ...
    ?>
        <br>
        <a href="wt-t10z1.php?logout=yes">Logout</a>
<?php
        endif;
    ?>
	</div>
	<?php
		if (isset($_POST['tekst']) && isset($_POST['idVijesti'])) {
			...
			if (!$rezultat) {
	     	...
	     	echo "<h1>Hvala vam na ostavljanju komentara!</h1><a href='wt-t10z1.php'>Nazad</a>";
	     	$veza = null;
		}
		else {
	?>
	...
	<?php
		...
		if (!$rezultat) {
     	...
     	foreach ($rezultat as $vijest) {
        	...
        	echo "<form method='post' action='wt-t10z1.php'><textarea name='tekst' placeholder='Ostavite komentar'></textarea><br><input type='hidden' name='idVijesti' value='".$vijest['id']."'><input type='submit' value='Potvrdi'></form><br>";
     	}
     	$veza = null;
 	}
	?>

<script src="wt-t10z1.js"></script>
</body>
</html>